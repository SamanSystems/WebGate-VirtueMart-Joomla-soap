...
class plgVmPaymentVmzarinpalwg extends vmPSPlugin {
	...
	function plgVmConfirmedOrder($cart, $order) {
		...
		$client = new SoapClient('https://de.zarinpal.com/pg/services/WebGate/wsdl', 'wsdl');
	...
	function plgVmOnPaymentResponseReceived(&$html) {
		...
		if ($virtuemart_order_id) {
			...
			if($_GET['Status'] == 'OK'){
				...
				$soapclient = new SoapClient('https://de.zarinpal.com/pg/services/WebGate/wsdl', 'wsdl');
